"""Joint-DDT sibling of ``diagnose_joint_pt_pickup.py``.
...
def diagnose(args):
    ...
    print(f"== num_steps: {cfg.optimization.joint_num_steps} | "
    ...
    print(f"\n[3/3] Running predictions on {len(demo_keys)} demos "
          f"(num_steps={cfg.optimization.joint_num_steps})...")
    ...
    for demo_key in demo_keys:
        ...
        axes[0].set_title(f"{demo_key}  T={T}  pickup_idx={pickup_idx}  (joint DDT)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_dir", type=str,
                        default="outputs/diagnose_joint_ddt_pickup")
