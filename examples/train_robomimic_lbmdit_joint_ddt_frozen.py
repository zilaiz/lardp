"""Training pipeline for the LBMDiTJointDDTFrozenAgent on robomimic.

DDT-trunk variant of the joint pipeline with a frozen (or optionally
fine-tuned) IDM-pretrained encoder. State-flow target is z-scored offline
...
from mip.agent_lbmdit_joint_ddt_frozen import LBMDiTJointDDTFrozenAgent  # noqa: E402
