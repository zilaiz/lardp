...
def get_default_step_list(loss_type: str):
    if loss_type in ["flow", "flow_repa", "flow_reg", "flow_condistill", "flow_fast_condistill", "flow_dual_condistill", "ctm", "lmd", "psd", "lsd", "esd", "mf"]:
...
def get_sampler(loss_type: str):
    if loss_type in {"flow", "flow_repa", "flow_condistill", "flow_fast_condistill", "flow_dual_condistill"}:
        return ode_sampler
