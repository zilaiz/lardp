...
class KitchenV0(robot_env.RobotEnv):
    ...
    def __init__(self, robot_params=None, frame_skip=40, use_abs_action=False):
...
class KitchenTaskRelaxV1(KitchenV0):
    ...
    def __init__(self, use_abs_action=False):
        super().__init__(use_abs_action=use_abs_action)
    ...
    def render(self, mode="human", width=1280, height=720, custom=True, **kwargs):
        if custom:
            ...
            return super().render(mode=mode, width=width, height=height, **kwargs)
